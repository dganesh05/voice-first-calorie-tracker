...
export default function ProfilePage() {
  ...
  }, [age, sex, heightFeet, heightInches, weight, activityLevel, goal, diet, useAutoGoals]);
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[32px] bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur">
              ...
              <h2 className="mt-1 text-2xl font-semibold">Personalized inputs</h2>
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                ...
                <SelectField
                  ...
                  editable={isEditing}
                  onChange={setGoal}
                  options={["Fat Loss", "Maintenance", "Lean Bulk", "Muscle Gain"]}
                />
            ...
            <div className="rounded-[32px] bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h2 className="mt-1 text-2xl font-semibold">Recommended daily goals</h2>
              ...
              <div className="mt-6 rounded-3xl bg-black/20 p-5 ring-1 ring-white/10">
                <p className="text-sm font-medium text-white/80">Goal strategy</p>
